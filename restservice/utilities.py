...
from restservice.config import PARENT_FOLDER, BACKUP_REPOSITORY_NAME, BACKUP_FOLDER, KEY_CONFIG_GET, \
    ...
    KEY_CONFIG_SET, BACKUP_CONFIG, SUBNET_RETREIVAL_FAILED, KEY_CONFIG_WRITE, KEY_FILENAME, \
    SUBNETS_RETREIVAL_FAILED, CONFIG_UPDATE_FAILED, KEY_OPTIONSDATA, INVALID_SUBNET, INVALID_RESERVATION, \
    KEY_OPTIONSDATA_CODE, BACKUP_CONFIG_PATH, RESERVATION_KEY_NOT_FOUND, ALL_RESERVATIONS_NOT_FOUND, \
    RESERVATION_NOT_FOUND, CONFIG_APPLY_FAILED, CONFIG_BACKUP_FAILED, CONFIG_SET_FAILED, CONFIG_TEST_FAILED, \
    SUBNETS_NOT_FOUND, ALL_SUBNETS_NOT_FOUND, OPTIONS_NOT_FOUND, ALL_OPTIONS_NOT_FOUND, INVALID_OPTIONS, \
    COMMIT_MESSAGE, GIT_PULL_FAILED, GIT_PUSH_FAILED, KEA_SERVER_BACKUP, GIT_BACKUP, GIT_LINK, \
    GIT_ASK_PASS, GIT_PASSWORD, GIT_USERNAME, PULL_SUCCESS_MESSAGE, KEY_LEASE4_GET_ALL, KEY_LEASE4_ADD, \
    KEY_LEASE4_DELETE, KEY_LEASE4_UPDATE, KEY_LEASE4_WIPE, CLIENT_CLASSES_NOT_FOUND, ALL_CLIENT_CLASSES_NOT_FOUND
