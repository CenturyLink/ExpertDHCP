...
HOST = CONFIGS['FASTDHCP']['HOST']
PORT = int(CONFIGS['FASTDHCP']['PORT'])
SERVICE_CODE = CONFIGS['FASTDHCP']['SERVICE_CODE']
REQUIRE_API_AUTHENTICATION = bool(CONFIGS['FASTDHCP']['REQUIRE_API_AUTHENTICATION'])
...
JWT_SECRET= CONFIGS['AUTH']['JWT_SECRET']
JWT_ALGORITHM = CONFIGS['AUTH']['JWT_ALGORITHM']
